...
class JuniperBaseProtocolTest(BaseJuniper):
    ...
    def test_access_mode(self):
        ...
        assert_that(int003.xpath(u"unit/family/ethernet-switching/port-mode")[0].text,
                    equal_to(u"access"))
    ...
    def test_trunk_mode_allows_no_vlan_members(self):
        ...
        self.cleanup(vlan(u"VLAN2995"), vlan(u"VLAN2996"), vlan(u"VLAN2997"), reset_interface(u"ge-0/0/3"))
        result = self.nc.get_config(source=u"running", filter=dict_2_etree({u"filter": {
            u"configuration": {u"vlans": {}}}
        }))
        assert_that(result.xpath(u"data/configuration/vlans/vlan"), has_length(0))
    ...
    def test_trunk_mode(self):
        ...
        assert_that(int003.xpath(u"name")[0].text, equal_to(u"ge-0/0/3"))
        assert_that(int003.xpath(u"unit/family/ethernet-switching/*"), has_length(3))
        assert_that(int003.xpath(u"unit/family/ethernet-switching/port-mode")[0].text,
                    equal_to(u"trunk"))
        assert_that(int003.xpath(u"unit/family/ethernet-switching/native-vlan-id")[0].text, equal_to(u"2996"))
                ...
                u"interface": [
                    ...
                    {u"unit": [
                        ...
                        {u"family": {
                            u"ethernet-switching": {
                                u"vlan": [
                                    {u"members": {XML_TEXT: u"2997", XML_ATTRIBUTES: {u"operation": u"delete"}}},
                                ]}}}]}]}})
        self.nc.commit()
    ...
    def test_interface_set_trunk_native_vlan_then_set_members_after(self):
        ...
        int003 = result.xpath(u"data/configuration/interfaces/interface")[0]
        assert_that(int003.xpath(u"unit/family/ethernet-switching/native-vlan-id")[0].text, equal_to(u"2995"))
    ...
    def test_passing_from_trunk_mode_to_access_gets_rid_of_stuff_in_trunk_mode(self):
        ...
        int003 = result.xpath(u"data/configuration/interfaces/interface")[0]
        assert_that(int003.xpath(u"unit/family/ethernet-switching/port-mode")[0].text, equal_to(u"trunk"))
        assert_that(int003.xpath(u"unit/family/ethernet-switching/native-vlan-id")[0].text, equal_to(u"1200"))
        ...
        int003 = result.xpath(u"data/configuration/interfaces/interface")[0]
        assert_that(int003.xpath(u"unit/family/ethernet-switching/port-mode")[0].text, equal_to(u"access"))
        assert_that(int003.xpath(u"unit/family/ethernet-switching/native-vlan-id"), has_length(0))
        assert_that(int003.xpath(u"unit/family/ethernet-switching/vlan/members"), has_length(0))

        self.cleanup(vlan(u"VLAN1100"), vlan(u"VLAN1200"), vlan(u"VLAN1300"), vlan(u"VLAN1400"), reset_interface(u"ge-0/0/3"))
        result = self.nc.get_config(source=u"running", filter=dict_2_etree({u"filter": {
            u"configuration": {u"vlans": {}}}
        }))
        assert_that(result.xpath(u"data/configuration/vlans/vlan"), has_length(0))
    ...
    def test_spanning_tree_options_are_not_affected_by_the_deletion_of_the_bond(self):
        ...
        result = self.nc.get_config(source=u"running", filter=dict_2_etree({u"filter": {
            u"configuration": {u"protocols": {u"rstp": {u"interface": {u"name": u"ae2"}}}}}
        }))

        assert_that(result.xpath(u"data/configuration/protocols/rstp/interface"), has_length(1))

        self.cleanup(reset_interface(u"ae2"))
    ...
    def test_set_interface_raises_on_aggregated_out_of_range_port(self):
        ...
        assert_that(str(exc.exception), contains_string(u"device value outside range 0..127 for '34345' in 'ae34345'"))
    ...
    def test_set_interface_disabling(self):
        ...
        assert_that(result.xpath(u"data/configuration/interfaces"), has_length(0))
    ...
    def test_set_interface_enabling_already_enabled(self):
        ...
        assert_that(str(exc.exception), is_(u"statement not found: "))
    ...
    def test_discard_trunk_members_really_works(self):
        ...
        before = self.nc.get_config(source=u"running", filter=dict_2_etree({u"filter": {
            u"configuration": [{u"interfaces": {}}, {u"vlans": {}}]}
        }))
        ...
        after = self.nc.get_config(source=u"running", filter=dict_2_etree({u"filter": {
            u"configuration": [{u"interfaces": {}}, {u"vlans": {}}]}
        }))

        assert_that(to_xml(before.xpath(u"data/configuration/vlans")[0]), xml_equals_to(after.xpath(u"data/configuration/vlans")[0]))
        assert_that(to_xml(before.xpath(u"data/configuration/interfaces")[0]), xml_equals_to(after.xpath(u"data/configuration/interfaces")[0]))

        self.cleanup(vlan(u"VLAN10"), reset_interface(u"ge-0/0/3"))
    ...
    def test_replace_port_with_nothing_leaves_configuration_empty(self):
        ...
        get_interface_reply = self.nc.get_config(source=u"running", filter=dict_2_etree({u"filter": {
            u"configuration": {u"interfaces": {u"interface": {u"name": u"ge-0/0/1"}}}}}))

        assert_that(get_interface_reply.xpath(u"data/configuration"), has_length(0))
        ...
        get_interface_reply = self.nc.get_config(source=u"running", filter=dict_2_etree({u"filter": {
            u"configuration": {u"interfaces": {u"interface": {u"name": u"ge-0/0/1"}}}}}))
        assert_that(get_interface_reply.xpath(u"data/configuration"), has_length(1))

        self.cleanup(reset_interface(u"ge-0/0/1"))
    ...
    def test_operational_request_get_interface_information_terse(self):
        ...
        assert_that(deleted_interface.xpath(u"*"), has_length(3))
        ...
        assert_that(access_mode_interface.xpath(u"*"), has_length(4))
        ...
        assert_that(bond_member_interface.xpath(u"*"), has_length(3))
        ...
        self.cleanup(reset_interface(u"ae3"),
    ...
    def test_removing_bond_membership_node_should_raise(self):
        ...
        assert_that(str(expect.exception), is_(u"statement not found: 802.3ad"))
